...
public interface IVehicleResource {
    ...
    ResponseEntity<Page<VehicleDTO>> findAll(@Parameter(description = "Page") int page, @Parameter(description = "Size of page") int size, @Parameter(description = "Ordination page") String sort);
